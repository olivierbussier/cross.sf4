...
*/
		var _CONST = {
			...
			iframeMinW : 350* 0.75 * 0.6,
			iframeMinH : 350 * 0.7 * 0.6,
			boxBorderW : 1,
		...
		var _settings = {			
			...
			boxBorderColor : "#394c87", // The border color of the preview box(affecting #previewbox, #previewbox-pointer and #previewbox > h5)
		...
		*/
		var _prepPreview = function () {
			...
			_CONST.iframeMaxW = _CONST.windowWidth * 0.75;
			...
			*/
			...
			/*	Arg:
					> styles = { // The setable styles
						iframeW : number, the width(in px) of the iframe for the preview page. 
              Cannot be over the client window width * 0.45 and below the client window width * 0.45 * 0.6
						iframeH : number, the height(in px) of the iframe for the preview page.
              Cannot be over the client window height * 0.7 and below the client window height * 0.7 * 0.6
