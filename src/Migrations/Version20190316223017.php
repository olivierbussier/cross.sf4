 ...
 */
final class Version20190316223017 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cross_config (id INT AUTO_INCREMENT NOT NULL, date_edition DATETIME NOT NULL, lien_trail VARCHAR(255) NOT NULL, lien_cross VARCHAR(255) NOT NULL, lien_marche VARCHAR(255) NOT NULL, lien_petit VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE cross_config');
